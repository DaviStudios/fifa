...
gdjs.MainSceneCode.GDStatsHitboxObjects1= [];
gdjs.MainSceneCode.GDStatsHitboxObjects2= [];
gdjs.MainSceneCode.GDStatsHitboxObjects3= [];
gdjs.MainSceneCode.GDStatsHitboxObjects4= [];
gdjs.MainSceneCode.GDStatsButtonObjects1= [];
gdjs.MainSceneCode.GDStatsButtonObjects2= [];
gdjs.MainSceneCode.GDStatsButtonObjects3= [];
gdjs.MainSceneCode.GDStatsButtonObjects4= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17055356);
}
}
if (isConditionTrue_0) {
...
gdjs.MainSceneCode.mapOfGDgdjs_9546MainSceneCode_9546GDStatsHitboxObjects1Objects = Hashtable.newFrom({"StatsHitbox": gdjs.MainSceneCode.GDStatsHitboxObjects1});
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("StatsHitbox"), gdjs.MainSceneCode.GDStatsHitboxObjects1);
...
}{for(var i = 0, len = gdjs.MainSceneCode.GDStatsHitboxObjects1.length ;i < len;++i) {
    gdjs.MainSceneCode.GDStatsHitboxObjects1[i].hide();
}
}{gdjs.evtTools.storage.readNumberFromJSONFile("User", "XP", runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(1));
}{gdjs.evtTools.storage.readNumberFromJSONFile("User", "Level", runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(2));
}{runtimeScene.getGame().getVariables().getFromIndex(17).setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(1)));
}{runtimeScene.getGame().getVariables().getFromIndex(18).setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(2)));
}{gdjs.evtTools.storage.readNumberFromJSONFile("User", "Goals", runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(3));
}{runtimeScene.getGame().getVariables().getFromIndex(19).setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(3)));
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.MainSceneCode.mapOfGDgdjs_9546MainSceneCode_9546GDStatsHitboxObjects1Objects, runtimeScene, true, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{let isConditionTrue_1 = false;
isConditionTrue_1 = false;
...
gdjs.MainSceneCode.GDStatsHitboxObjects1.length = 0;
gdjs.MainSceneCode.GDStatsHitboxObjects2.length = 0;
gdjs.MainSceneCode.GDStatsHitboxObjects3.length = 0;
gdjs.MainSceneCode.GDStatsHitboxObjects4.length = 0;
gdjs.MainSceneCode.GDStatsButtonObjects1.length = 0;
gdjs.MainSceneCode.GDStatsButtonObjects2.length = 0;
gdjs.MainSceneCode.GDStatsButtonObjects3.length = 0;
gdjs.MainSceneCode.GDStatsButtonObjects4.length = 0;
gdjs.MainSceneCode.GDcursorObjects1.length = 0;
